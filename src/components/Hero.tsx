...
export const Hero: React.FC = () => {
  ...
  return (
    <section 
      id="brand-hero" 
      className="min-h-screen flex flex-col justify-between items-center relative bg-white bg-grid-subtle px-4 sm:px-6 lg:px-8 py-8 sm:py-12 select-none overflow-hidden"
    >
      {/* Top Status Tag */}
