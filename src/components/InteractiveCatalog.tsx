              ...
              <LiquidButton
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition-all duration-300 flex items-center gap-1.5 cursor-pointer ${
                  selectedCategory === cat.id
                    ...
                    : 'bg-white/80 text-slate-700 border border-slate-200/80 hover:border-slate-300 hover:text-slate-900'
                }`}
              >
            ...
            >
              ...
              <div className="p-6 pt-0 flex items-center gap-2.5">
                <LiquidButton
                  ...
                  size="sm"
                  className="flex-1 py-2.5 px-3 rounded-xl text-xs font-semibold bg-slate-950 hover:bg-slate-800 text-white transition-all flex items-center justify-center gap-2 tracking-wide cursor-pointer"
                >
                ...
                <LiquidButton
                  ...
                  size="sm"
                  className="py-2.5 px-4 rounded-xl text-xs font-semibold bg-white/80 hover:bg-slate-100 text-slate-700 border border-slate-200 transition-colors cursor-pointer"
                >
                  <span>Specs</span>
                </LiquidButton>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-lg w-full p-6 sm:p-8 relative animate-brand-reveal">
              ...
              <div className="flex gap-3">
                <LiquidButton
                  ...
                  size="lg"
                  className="w-full py-3 rounded-xl text-xs font-semibold bg-slate-950 hover:bg-slate-800 text-white flex items-center justify-center gap-2 tracking-wide cursor-pointer"
                >
