...
import { Search, Compass, ArrowRight, MessageSquare, ShieldCheck, Sparkles } from 'lucide-react';
...
export const WheelProfilesBlueprint: React.FC = () => {
  ...
  return (
    <section id="wheel-types" className="py-24 bg-[#FAF9F6] text-slate-900 border-b border-slate-200 relative overflow-hidden">
